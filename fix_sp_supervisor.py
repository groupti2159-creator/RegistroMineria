...
def fix_sp_supervisor():
    with app.app_context():
        cur = mysql.connection.cursor()
        
        cur.execute("DROP PROCEDURE IF EXISTS SP_ListarRegistrosSupervisor")
        ...
        print("OK: SP_ListarRegistrosSupervisor actualizado con CCTA y conteo de imagenes")
        cur.close()
