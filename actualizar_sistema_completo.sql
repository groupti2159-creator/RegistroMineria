...
-- ============================================================
-- SCRIPT COMPLETO: ACTUALIZACIÓN DEL SISTEMA
-- Ejecuta solo este archivo para aplicar todos los cambios
-- ============================================================

-- 1. Agregar columna Activo a la tabla Tbl_Estado (si no existe)
ALTER TABLE Tbl_Estado ADD COLUMN IF NOT EXISTS Activo TINYINT(1) DEFAULT 1;

-- 2. Actualizar descripciones de los estados principales
...
-- 3. Marcar solo los 3 estados principales como activos
UPDATE Tbl_Estado SET Activo = 0; -- Desactivar todos primero
UPDATE Tbl_Estado SET Activo = 1 WHERE idEstado IN ('EST001', 'EST003', 'EST006');

-- 4. Actualizar registros existentes que usen estados intermedios
...
-- ============================================================
-- 9. ACTUALIZAR SP_ArchivarRegistro
-- ============================================================
...
-- ============================================================
-- 10. ACTUALIZAR SP_ImagenesRegistro (filtrar rechazadas)
-- ============================================================
...
-- RESUMEN DE CAMBIOS
-- ============================================================
SELECT '✅ Sistema actualizado correctamente' AS resultado;
SELECT '' AS separador;
SELECT 'Estados activos:' AS info;
SELECT idEstado, Estado, Descripcion, Activo, Orden 
FROM Tbl_Estado 
WHERE Activo = 1
ORDER BY Orden;
